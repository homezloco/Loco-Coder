              ...
              <div className="option-row">
                <label className="option-label">
                  <input
                    ...
                    onChange={() => setAdvancedOptions(prev => ({
                      ...prev,
                      includeDocumentation: !prev.includeDocumentation
                    }))}
                  />
              ...
              <div className="option-row">
                <label className="option-label">
                  <input
                    ...
                    onChange={() => setAdvancedOptions(prev => ({
                      ...prev,
                      includeTests: !prev.includeTests
                    }))}
                  />
                  Include Tests
                </label>
              ...
              <div className="option-row">
                <label className="option-label">
                  <input
                    ...
                    onChange={() => setAdvancedOptions(prev => ({
                      ...prev,
                      includeDocker: !prev.includeDocker
                    }))}
                  />
              ...
              <div className="option-row">
                <label className="option-label">
                  <input
                    ...
                    onChange={() => setAdvancedOptions(prev => ({
                      ...prev,
                      optimizeForPerformance: !prev.optimizeForPerformance
                    }))}
                  />
              ...
              <div className="option-row">
                <label className="option-label">
                  <input
                    ...
                    onChange={() => setAdvancedOptions(prev => ({
                      ...prev,
                      includeExamples: !prev.includeExamples
                    }))}
                  />
                  Include Examples
                </label>
          ...
          {errorDetails && (
            <div className="error-details">
              ...
              <div className="error-actions">
                ...
                <li>Try a different technology stack</li>
                <li>Simplify your project requirements</li>
