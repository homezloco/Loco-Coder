  ...
  static async generateProject(projectInfo, plan, onProgress = () => {}) {
    try {
      ...
      const project = {
        ...
        name: projectName,
        description: projectInfo.description || plan.projectDescription || 'A new project generated by Windsurf AI',
...
/* Generated by Windsurf AI */\n\n.${filename.split('.')[0].toLowerCase()} {
  ...
  "license": "ISC"
      ...
      default:
        return `# ${filename}\n\nThis file was generated by Windsurf AI.`;
    }
  }
...
${project.description || 'A new project generated by Windsurf AI'}
